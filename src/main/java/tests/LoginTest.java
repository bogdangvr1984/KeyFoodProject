...
public class LoginTest extends BaseTest {
	...
	public void validLoginTest(String user, String pass) {
		...
		myAccount.loingInApp(user, pass);
		assertTrue(myAccount.loginMsgIsDisplayed(myAccount.usernameGreetings));
	...
	public void invalidLoginTest(String user, String pass) {
		...
		menu.click(menu.myAccountLink);
		myAccount.loingInApp(user, pass);
		assertTrue(myAccount.loginMsgIsDisplayed(myAccount.loginErrorMsg));
	}
